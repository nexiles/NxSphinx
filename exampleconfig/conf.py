# -*- coding: utf-8 -*-
#
# nexiles|developer-training documentation build configuration file, created by
# sphinx-quickstart on Mon Feb  4 12:03:25 2014.
#
...
project = u"Sven Schmid - Praktische Ausbildereignungsprüfung"
copyright = u'Sven Schmid'
...
htmlhelp_basename = 'svenschmidaevo'
...
latex_documents = [
  ('index', htmlhelp_basename+'.tex', u'Sven Schmid\\textbar{}Praktische Ausbildereignungsprüfung nach AEVO',
   u'Sven Schmid', 'manual'),
]

# preamb_old = ur'''%\documentclass{memoir}
# \makeatletter
...
# \definecolor{VerbatimBorderColor}{cmyk}{1,0.5,0.5,0.5}
# \setromanfont{Comic Sans MS}
# \setsansfont[Colour=AA0000]{Comic Sans MS}
# '''

# #f = open('static/latexstyling.tex', 'r+')
# #PREAMBLE = f.read();
